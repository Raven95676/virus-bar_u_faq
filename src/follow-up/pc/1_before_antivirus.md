...
2. 进入PE后，由于可以联网，打开浏览器下载安装360杀毒或火绒杀毒软件。
3. 全盘扫描并处理威胁。

另：360系统急救箱PE版已不再推荐使用。
...
可以使用PE重置系统。关于PE的制作和使用，请参考[制作WindowsPE以备不时之需](https://faq.ravenote.top/prevention/basic/4_why_windows_pe.html)中的相关介绍。
